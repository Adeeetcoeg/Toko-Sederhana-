...
<html lang="en">
    <head>
        ...
        <meta content="Toko Kimia Farma Menjual semua jenis obat obatan" name="description">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-custom shadow-sm py-3 fixed-top">
            <div class="container">
                ...
                <div class="navbar-brand">
                    <a href="{{ url('/') }}"><img src="{{asset('assets/img/logo.jpg')}}" height="50px" alt="logo"></a>
                </div>
        ...
        <div class="copyright">
            <div class="container text-center">
                Copyright &copy; <?= date('Y');?> By:Aditya Nugroho
            </div>
        </div>
        <!-- end footer -->
        <!-- modal cari -->
